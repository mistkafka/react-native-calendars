...
class WeekCalendar extends Component {
  constructor(props) {
    ...
    _defineProperty(this, "onMomentumScrollEnd", () => {
      const {
        items
      } = this.state;
    ...
    _defineProperty(this, "renderItem", ({
      ...
      return /*#__PURE__*/React.createElement(Week, _extends({}, others, {
        key: item,
        current: item,
        style: [{
          width: calendarWidth || this.containerWidth
        }, style],
  ...
  getDate(weekIndex) {
    ...
    const d = XDate(current || context.date); // get the first day of the week as date (for the on scroll mark)
  ...
  render() {
    ...
    }, !hideDayNames && /*#__PURE__*/React.createElement(View, {
      style: [this.style.week, {
        marginTop: 12,
        marginBottom: -2
      }]
    }, weekDaysNames.map((day, idx) => /*#__PURE__*/React.createElement(Text, {
      allowFontScaling: false,
      key: idx,
      style: this.style.dayHeader,
      numberOfLines: 1,
      accessibilityLabel: '' // accessible={false} // not working
      // importantForAccessibility='no'

    }, day))), /*#__PURE__*/React.createElement(FlatList, {
      ref: this.list,
      data: items,
      extraData: extraData,
...
_defineProperty(WeekCalendar, "displayName", 'WeekCalendar');

_defineProperty(WeekCalendar, "defaultProps", {
  firstDay: 0,
  allowShadow: true
});
