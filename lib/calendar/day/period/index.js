...
export default class PeriodDay extends Component {
  ...
  render() {
    ...
    if (marking) {
      ...
      fillers = /*#__PURE__*/React.createElement(View, {
        style: [this.style.fillers, fillerStyle]
      }, /*#__PURE__*/React.createElement(View, {
        style: [this.style.leftFiller, leftFillerStyle]
      }), /*#__PURE__*/React.createElement(View, {
        style: [this.style.rightFiller, rightFillerStyle]
      }));
    }
    ...
    return /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
      ...
      style: textStyle
    }, String(this.props.children)), /*#__PURE__*/React.createElement(Dot, {
      theme: theme,
      color: dotColor,
      marked: marked
    }))));
...
_defineProperty(PeriodDay, "displayName", 'IGNORE');