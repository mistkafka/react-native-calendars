...
export default class AgendaView extends Component {
  constructor(props) {
    ...
    _defineProperty(this, "initialScrollPadPosition", () => {
      return Math.max(0, this.viewHeight - HEADER_HEIGHT);
    });

    _defineProperty(this, "setScrollPadPosition", (y, animated) => {
      if (this.scrollPad.scrollTo) {
        this.scrollPad.scrollTo({
          x: 0,
          y,
          animated
        });
        ...
        this.scrollPad.getNode().scrollTo({
          x: 0,
          y,
          animated
        });
    ...
    _defineProperty(this, "chooseDayFromCalendar", d => {
      this.chooseDay(d, !this.state.calendarScrollable);
    });

    _defineProperty(this, "generateMarkings", () => {
      const {
        markedDates,
        items
      } = this.props;
    ...
    _defineProperty(this, "onScrollPadLayout", () => {
      // When user touches knob, the actual component that receives touch events is a ScrollView.
      // It needs to be scrolled to the bottom, so that when user moves finger downwards,
      // scroll position actually changes (it would stay at 0, when scrolled to the top).
      this.setScrollPadPosition(this.initialScrollPadPosition(), false); // delay rendering calendar in full height because otherwise it still flickers sometimes
    ...
    _defineProperty(this, "onCalendarListLayout", () => {
    ...
    _defineProperty(this, "onStartDrag", () => {
      this.headerState = 'dragged';
      this.knobTracker.reset();
    });

    _defineProperty(this, "onSnapAfterDrag", e => {
    ...
    _defineProperty(this, "onVisibleMonthsChange", months => {
    ...
    _defineProperty(this, "onDayChange", day => {
  ...
  enableCalendarScrolling() {
    ...
    _.invoke(this.props, 'onCalendarToggled', true); // Enlarge calendarOffset here as a workaround on iOS to force repaint.
  ...
  renderReservations() {
    ...
    return /*#__PURE__*/React.createElement(ReservationList, _extends({}, reservationListProps, {
      ref: c => this.list = c,
  ...
  renderCalendarList() {
    ...
    return /*#__PURE__*/React.createElement(CalendarList, _extends({}, calendarListProps, {
  ...
  renderKnob() {
    ...
    let knob = /*#__PURE__*/React.createElement(View, {
      style: this.style.knobContainer
    });

    if (!hideKnob) {
      const knobView = renderKnob ? renderKnob() : /*#__PURE__*/React.createElement(View, {
        style: this.style.knob
      });
      knob = this.state.calendarScrollable ? null : /*#__PURE__*/React.createElement(View, {
        style: this.style.knobContainer
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(View, {
    ...
    }, this.renderReservations()), /*#__PURE__*/React.createElement(Animated.View, {
      style: headerStyle
    ...
    }, this.renderCalendarList()), this.renderKnob()), /*#__PURE__*/React.createElement(Animated.View, {
      style: weekdaysStyle
      ...
      style: this.style.weekday,
      numberOfLines: 1
    }, day))), /*#__PURE__*/React.createElement(Animated.ScrollView, {
...
_defineProperty(AgendaView, "displayName", 'Agenda');